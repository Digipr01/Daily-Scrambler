...
async def command_2x2(interaction, amount: typing.Literal["Single", "Mo3", "Ao5"] = "Single"):
	await interaction.response.send_message(embed=scramble("two", AverageTypes[amount], sender=interaction.user))
...
async def command_3x3(interaction, amount: typing.Literal["Single", "Mo3", "Ao5"] = "Single"):
	await interaction.response.send_message(embed=scramble("three", AverageTypes[amount], sender=interaction.user))
...
async def command_4x4(interaction, amount: typing.Literal["Single", "Mo3", "Ao5"] = "Single"):
	await interaction.response.send_message(embed=scramble("four_fast", AverageTypes[amount], sender=interaction.user))
...
async def command_5x5(interaction, amount: typing.Literal["Single", "Mo3", "Ao5"] = "Single"):
	await interaction.response.send_message(embed=scramble("five", AverageTypes[amount], sender=interaction.user))
...
async def command_6x6(interaction, amount: typing.Literal["Single", "Mo3", "Ao5"] = "Single"):
	await interaction.response.send_message(embed=scramble("six", AverageTypes[amount], sender=interaction.user))
...
async def command_7x7(interaction, amount: typing.Literal["Single", "Mo3", "Ao5"] = "Single"):
	await interaction.response.send_message(embed=scramble("seven", AverageTypes[amount], sender=interaction.user))
...
async def command_skewb(interaction, amount: typing.Literal["Single", "Mo3", "Ao5"] = "Single"):
	await interaction.response.send_message(embed=scramble("skewb", AverageTypes[amount], sender=interaction.user))
...
async def command_megaminx(interaction, amount: typing.Literal["Single", "Mo3", "Ao5"] = "Single"):
	await interaction.response.send_message(embed=scramble("mega", AverageTypes[amount], sender=interaction.user))
...
async def command_pyraminx(interaction, amount: typing.Literal["Single", "Mo3", "Ao5"] = "Single"):
	await interaction.response.send_message(embed=scramble("pyra", AverageTypes[amount], sender=interaction.user))
...
async def command_square_1(interaction, amount: typing.Literal["Single", "Mo3", "Ao5"] = "Single"):
	print(amount)
	await interaction.response.send_message(embed=scramble("sq1", AverageTypes[amount], sender=interaction.user))
...
async def command_3bld(interaction, amount: typing.Literal["Single", "Mo3"] = "Single"):
	print(amount)
	await interaction.response.send_message(embed=scramble("three_ni", AverageTypes[amount], sender=interaction.user))
...
async def command_4bld(interaction, amount: typing.Literal["Single", "Mo3"] = "Single"):
	print(amount)
	await interaction.response.send_message(embed=scramble("four_ni", AverageTypes[amount], sender=interaction.user))
...
async def command_5bld(interaction, amount: typing.Literal["Single", "Mo3"] = "Single"):
	print(amount)
	await interaction.response.send_message(embed=scramble("five_ni", AverageTypes[amount], sender=interaction.user))
	
@tree.command(name="fmc", description="Generates scrambles for the 3x3 fewest move challenge.")
async def command_fmc(interaction):
	await interaction.response.send_message(embed=scramble("three_fm", 1, sender=interaction.user))
